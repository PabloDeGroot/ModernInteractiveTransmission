...
declare module '$env/static/private' {
	...
	export const NVIDIA_VIDEO_CODEC_SDK_PATH: string;
	...
	export const TRACEDESIGNTIME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NVIDIA_VIDEO_CODEC_SDK_PATH: string;
